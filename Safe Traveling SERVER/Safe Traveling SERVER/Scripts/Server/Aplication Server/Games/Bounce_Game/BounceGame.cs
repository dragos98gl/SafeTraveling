...
namespace Safe_Traveling_SERVER.Scripts.Server.Aplication_Server.Games.Bounce_Game
{
    class BounceGame:Game
    {
        BounceGame_Player Player1;
        BounceGame_Player Player2;
        ...
        {
            Player2 = new BounceGame_Player(P2);
    ...
    class BounceGame_Player
    {
        public Client Client;

        public BounceGame_Player(Client Client)
        {
            this.Client = Client;
        }
